...
function ACMFooter() {
  return /* @__PURE__ */ jsx("div", { className: "footerWrapper", children: /* @__PURE__ */ jsxs("footer", { children: [
    ...
    /* @__PURE__ */ jsx("div", { className: "disclaimer", children: "This is a PFW-ACM site. The views on this page do not represent the views of Purdue Fort Wayne. " })
  ] }) });
}
